...
// Lower from a "smt.bv.uaddo" operation.

builtin.module {
  %x = "smt.declare_const"() : () -> !smt.bv<32>
  %y = "smt.declare_const"() : () -> !smt.bv<32>
  %pred = "smt.bv.uaddo"(%x, %y) : (!smt.bv<32>, !smt.bv<32>) -> !smt.bool
...
// CHECK-NEXT:  %pred = "smt.bv.add"(%x, %y) : (!smt.bv<32>, !smt.bv<32>) -> !smt.bv<32>
// CHECK-NEXT:  %pred_1 = "smt.bv.ult"(%pred, %x) : (!smt.bv<32>, !smt.bv<32>) -> !smt.bool
