...
// CHECK-NEXT:      %2 = "smt.bv.constant"() {value = #smt.bv.bv_val<126: 64>} : () -> !smt.bv<64>
// CHECK-NEXT:      %3, %4 = mem_effect.alloc %1, %2
// CHECK-NEXT:      %5 = "smt.bv.constant"() {value = #smt.bv.bv_val<5: 8>} : () -> !smt.bv<8>
...
// CHECK-NEXT:      %7 = "smt.bv.constant"() {value = #smt.bv.bv_val<97: 64>} : () -> !smt.bv<64>
// CHECK-NEXT:      %8 = mem_effect.offset_ptr %4[%7]
// CHECK-NEXT:      %9 = mem_effect.write %value, %3[%8] : !smt.utils.pair<!smt.bv<8>, !smt.bool>
// CHECK-NEXT:      %10 = "smt.bv.constant"() {value = #smt.bv.bv_val<97: 64>} : () -> !smt.bv<64>
