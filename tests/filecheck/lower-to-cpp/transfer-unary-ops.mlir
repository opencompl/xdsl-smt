...
// CHECK:       APInt get_bw_test(APInt x){
// CHECK-NEXT:  	unsigned r_autocast = x.getBitWidth();
// CHECK-NEXT:  	APInt r(x.getBitWidth(),r_autocast);
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt countl_zero_test(APInt x){
// CHECK-NEXT:  	unsigned r_autocast = x.countl_zero();
// CHECK-NEXT:  	APInt r(x.getBitWidth(),r_autocast);
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt countr_zero_test(APInt x){
// CHECK-NEXT:  	unsigned r_autocast = x.countr_zero();
// CHECK-NEXT:  	APInt r(x.getBitWidth(),r_autocast);
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt countl_one_test(APInt x){
// CHECK-NEXT:  	unsigned r_autocast = x.countl_one();
// CHECK-NEXT:  	APInt r(x.getBitWidth(),r_autocast);
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt countr_one_test(APInt x){
// CHECK-NEXT:  	unsigned r_autocast = x.countr_one();
// CHECK-NEXT:  	APInt r(x.getBitWidth(),r_autocast);
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt neg_test(APInt x){
// CHECK-NEXT:  	APInt r = ~x;
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt clear_sign_bit_test(APInt x){
// CHECK-NEXT:  	APInt r = x;
// CHECK-NEXT:  	r.clearSignBit();
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt set_sign_bit_test(APInt x){
// CHECK-NEXT:  	APInt r = x;
// CHECK-NEXT:  	r.setSignBit();
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt get_all_ones_test(APInt x){
// CHECK-NEXT:  	APInt r = APInt::getAllOnes(x.getBitWidth());
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt get_signed_max_value_test(APInt x){
// CHECK-NEXT:  	APInt r = APInt::getSignedMaxValue(x.getBitWidth());
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt get_signed_min_value_test(APInt x){
// CHECK-NEXT:  	APInt r = APInt::getSignedMinValue(x.getBitWidth());
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
// CHECK-NEXT:  APInt reverse_bits_test(APInt x){
// CHECK-NEXT:  	APInt r = x.reverseBits();
// CHECK-NEXT:  	return r;
// CHECK-NEXT:  }
