...
"func.func"() ({
  ...
  ^bb0(%arg0: !transfer.integer, %arg1: !transfer.integer):
    ...
    %addRes = "transfer.shl"(%arg0, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %bitwidth = "transfer.get_bit_width"(%arg0): (!transfer.integer) -> !transfer.integer
    %overflow = "transfer.cmp"(%bitwidth, %arg1){predicate=6:i64}:(!transfer.integer,!transfer.integer)->i1
