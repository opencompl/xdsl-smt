...
"builtin.module"() ({
  "func.func"() ({
  ^0(%x : !transfer.integer<@W>):
    %r = "transfer.popcount"(%x) : (!transfer.integer<@W>) -> !transfer.integer<@W>
    "func.return"(%r) : (!transfer.integer<@W>) -> ()
  }) {"sym_name" = "test", "function_type" = (!transfer.integer<@W>) -> !transfer.integer<@W>, "sym_visibility" = "private"} : () -> ()
