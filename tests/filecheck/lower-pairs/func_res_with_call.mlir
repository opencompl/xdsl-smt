...
"builtin.module"() ({
  ...
  %0 = "smt.define_fun"() ({
  ^0(%arg : !smt.bool):
    %1 = "smt.bv.constant"() {value = #smt.bv.bv_val<3: 32>} : () -> !smt.bv<32>
...
// CHECK-NEXT:      %1 = "smt.constant"() <{value = false}> : () -> !smt.bool
...
// CHECK-NEXT:      %3 = "smt.bv.constant"() {value = #smt.bv.bv_val<3: 32>} : () -> !smt.bv<32>
...
// CHECK-NEXT:      %5 = "smt.constant"() <{value = false}> : () -> !smt.bool
// CHECK-NEXT:      "smt.return"(%5) : (!smt.bool) -> ()
// CHECK-NEXT:    }) {fun_name = "test_first"} : () -> ((!smt.bool) -> !smt.bool)
// CHECK-NEXT:    %true = "smt.constant"() <{value = true}> : () -> !smt.bool
