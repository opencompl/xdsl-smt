...
// CHECK-NEXT:      %4 = "smt.bv.extract"(%2) {start = #builtin.int<0>, end = #builtin.int<15>} : (!smt.bv<32>) -> !smt.bv<16>
// CHECK-NEXT:      %r = "smt.utils.pair"(%4, %3) : (!smt.bv<16>, !smt.bool) -> !smt.utils.pair<!smt.bv<16>, !smt.bool>
// CHECK-NEXT:      "smt.return"(%r, %1) : (!smt.utils.pair<!smt.bv<16>, !smt.bool>, !effect.state) -> ()
// CHECK-NEXT:    }) {fun_name = "test"} : () -> ((!smt.utils.pair<!smt.bv<32>, !smt.bool>, !effect.state) -> (!smt.utils.pair<!smt.bv<16>, !smt.bool>, !effect.state))
// CHECK-NEXT:  }
