...
"builtin.module"() ({
  ...
  ^0(%x : !transfer.integer<@W>, %y : !transfer.integer<@W>):
    %r = "transfer.clear_sign_bit"(%x) : (!transfer.integer<@W>) -> !transfer.integer<@W>
...
// CHECK-NEXT:    %2 = smt.bv.constant #smt.bv<64> : !smt.bv<8>
// CHECK-NEXT:    %r = "smt.bv.and"(%2, %x) : (!smt.bv<8>, !smt.bv<8>) -> !smt.bv<8>
