// RUN: xdsl-smt %s -p=lower-memory-to-array --split-input-file | filecheck %s
// RUN: xdsl-smt %s -p=lower-memory-to-array,lower-pairs -t=smt | z3 -in

%memory = "smt.declare_const"() : () -> !memory.memory
// CHECK:         %memory = "smt.declare_const"() : () -> !smt.array.array<!smt.int.int, !smt.utils.pair<!smt.array.array<!smt.int.int, !smt.utils.pair<!smt.bv.bv<8>, !smt.bool>>, !smt.bool>>
...
// CHECK-NEXT:    %block = "smt.declare_const"() : () -> !smt.utils.pair<!smt.array.array<!smt.int.int, !smt.utils.pair<!smt.bv.bv<8>, !smt.bool>>, !smt.bool>
