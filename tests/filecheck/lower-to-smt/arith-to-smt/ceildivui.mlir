...
// CHECK-NEXT:      %13 = "smt.bv.sub"(%2, %7) : (!smt.bv<32>, !smt.bv<32>) -> !smt.bv<32>
// CHECK-NEXT:      %14 = "smt.bv.udiv"(%13, %4) : (!smt.bv<32>, !smt.bv<32>) -> !smt.bv<32>
// CHECK-NEXT:      %15 = "smt.bv.add"(%14, %7) : (!smt.bv<32>, !smt.bv<32>) -> !smt.bv<32>
// CHECK-NEXT:      %16 = "smt.ite"(%12, %6, %15) : (!smt.bool, !smt.bv<32>, !smt.bv<32>) -> !smt.bv<32>
// CHECK-NEXT:      %r = "smt.utils.pair"(%16, %3) : (!smt.bv<32>, !smt.bool) -> !smt.utils.pair<!smt.bv<32>, !smt.bool>
// CHECK-NEXT:      "smt.return"(%r, %11) : (!smt.utils.pair<!smt.bv<32>, !smt.bool>, !effect.state) -> ()
