...
def register_all_arguments(arg_parser: argparse.ArgumentParser):
    arg_parser.add_argument(
        "input", type=str, help="path to before input file"
    )
    ...
    arg_parser.add_argument(
        "--toMLIR", type=bool, nargs="?", help="transfer to MLIR"
    )

    arg_parser.add_argument(
        "--toDSL", type=bool, nargs="?", help="transfer to DSL"
    )
...
class MLIRtoDSL:
    ...
    def lowerFunc(self, func:FuncOp) -> str:
        ...
        argsNameAndType=[arg.name_hint +" : " + self.lowerType(arg.type) for arg in func.args]
...
class DSLOperation:
    def __init__(self, opName:str, args:list[DSLValue], attrs:list[DSLAttribute], results:list[DSLValue]) -> None:
        self.opName=opName
        self.args=args
        self.attrs=attrs
...
class DSLFuncntion:
    def __init__(self,funcName:str, args:list[DSLValue], operations:list[DSLOperation]) -> None:
