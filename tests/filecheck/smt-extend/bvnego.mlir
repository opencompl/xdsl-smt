...
builtin.module {
  ...
  %pred = "smt.bv.nego"(%x) : (!smt.bv.bv<32>) -> !smt.bool
...
// CHECK-NEXT:  %pred = "smt.bv.constant"() {value = #smt.bv.bv_val<2147483648: 32>} : () -> !smt.bv.bv<32>
// CHECK-NEXT:  %pred_1 = "smt.eq"(%pred, %x) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bool
