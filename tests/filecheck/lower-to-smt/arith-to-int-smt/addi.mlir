...
//CHECK-NEXT:     %4 = "smt.int.constant"() {"value" = 3 : i64} : () -> !smt.int.int
//CHECK-NEXT:     %5 = "smt.int.mod"(%4, %3) : (!smt.int.int, !smt.int.int) -> !smt.int.int
//CHECK-NEXT:     %6 = "smt.constant_bool"() {"value" = #smt.bool_attr<false>} : () -> !smt.bool
//CHECK-NEXT:     %7 = "smt.utils.pair"(%5, %6) : (!smt.int.int, !smt.bool) -> !smt.utils.pair<!smt.int.int, !smt.bool>
...
//CHECK-NEXT:     %17 = "smt.int.add"(%13, %14) : (!smt.int.int, !smt.int.int) -> !smt.int.int
//CHECK-NEXT:     %18 = "smt.int.mod"(%17, %10) : (!smt.int.int, !smt.int.int) -> !smt.int.int
//CHECK-NEXT:     %19 = "smt.int.add"(%18, %10) : (!smt.int.int, !smt.int.int) -> !smt.int.int
//CHECK-NEXT:     %20 = "smt.int.mod"(%19, %10) : (!smt.int.int, !smt.int.int) -> !smt.int.int
//CHECK-NEXT:     %21 = "smt.or"(%15, %16) : (!smt.bool, !smt.bool) -> !smt.bool
//CHECK-NEXT:     %22 = "smt.utils.pair"(%20, %21) : (!smt.int.int, !smt.bool) -> !smt.utils.pair<!smt.int.int, !smt.bool>
//CHECK-NEXT:     %y = "smt.utils.pair"(%22, %10) : (!smt.utils.pair<!smt.int.int, !smt.bool>, !smt.int.int) -> !smt.utils.pair<!smt.utils.pair<!smt.int.int, !smt.bool>, !smt.int.int>
//CHECK-NEXT:   }
