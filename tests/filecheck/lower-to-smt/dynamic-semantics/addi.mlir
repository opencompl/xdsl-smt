...
func.func @f(%x: i32, %y: i32) -> (i32) {
  ...
  pdl.pattern : benefit(1) {
    ...
    pdl.rewrite %root {
      %smt_i32_type = pdl.type: !smt.bv<32>
      ...
      // Pack the result
      %smt_pair_type = pdl.type: !smt.utils.pair<!smt.bv<32>,!smt.bool>
...
// CHECK-NEXT:        %smt_i32_type = pdl.type {__operand_types = []} : !smt.bv<32>
...
// CHECK-NEXT:        %smt_pair_type = pdl.type {__operand_types = []} : !smt.utils.pair<!smt.bv<32>, !smt.bool>
