...
"builtin.module"() ({
  ...
  ^0(%x : !transfer.integer<@W>, %y : !transfer.integer<@W>):
    %r = "transfer.set_sign_bit"(%x) : (!transfer.integer<@W>) -> !transfer.integer<@W>
...
// CHECK-NEXT:    %2 = smt.bv.constant #smt.bv<128> : !smt.bv<8>
// CHECK-NEXT:    %r = "smt.bv.or"(%2, %x) : (!smt.bv<8>, !smt.bv<8>) -> !smt.bv<8>
