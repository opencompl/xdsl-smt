...
// CHECK-NEXT:      %18 = "smt.bv.slt"(%2, %11) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bool
// CHECK-NEXT:      %19 = "smt.bv.slt"(%4, %11) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bool
// CHECK-NEXT:      %20 = "smt.xor"(%18, %19) : (!smt.bool, !smt.bool) -> !smt.bool
// CHECK-NEXT:      %21 = "smt.bv.srem"(%2, %4) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bv.bv<32>
// CHECK-NEXT:      %22 = "smt.distinct"(%21, %11) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bool
// CHECK-NEXT:      %23 = "smt.bv.add"(%17, %7) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bv.bv<32>
// CHECK-NEXT:      %24 = "smt.and"(%20, %22) : (!smt.bool, !smt.bool) -> !smt.bool
// CHECK-NEXT:      %25 = "smt.ite"(%24, %23, %17) : (!smt.bool, !smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bv.bv<32>
// CHECK-NEXT:      %r = "smt.utils.pair"(%25, %3) : (!smt.bv.bv<32>, !smt.bool) -> !smt.utils.pair<!smt.bv.bv<32>, !smt.bool>
