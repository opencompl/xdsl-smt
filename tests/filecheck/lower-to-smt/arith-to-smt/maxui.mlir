...
// CHECK-NEXT:      %7 = "smt.bv.ugt"(%2, %4) : (!smt.bv<32>, !smt.bv<32>) -> !smt.bool
// CHECK-NEXT:      %8 = "smt.ite"(%7, %2, %4) : (!smt.bool, !smt.bv<32>, !smt.bv<32>) -> !smt.bv<32>
// CHECK-NEXT:      %r = "smt.utils.pair"(%8, %6) : (!smt.bv<32>, !smt.bool) -> !smt.utils.pair<!smt.bv<32>, !smt.bool>
