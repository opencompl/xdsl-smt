...
// CHECK-NEXT:       %3 = "smt.utils.first"(%y) : (!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>) -> !smt.bv.bv<32>
// CHECK-NEXT:       %4 = "smt.bv.add"(%2, %3) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bv.bv<32>
// CHECK-NEXT:       %5 = "smt.utils.second"(%x) : (!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>) -> !smt.bool
// CHECK-NEXT:       %6 = "smt.utils.second"(%y) : (!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>) -> !smt.bool
...
// CHECK-NEXT:       %8 = "smt.utils.pair"(%z, %1) : (!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>, !effect.state) -> !smt.utils.pair<!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>, !effect.state>
// CHECK-NEXT:       "smt.return"(%8) : (!smt.utils.pair<!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>, !effect.state>) -> ()
// CHECK-NEXT:     }) {"fun_name" = "f"} : () -> ((!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>, !smt.utils.pair<!smt.bv.bv<32>, !smt.bool>, !effect.state) -> !smt.utils.pair<!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>, !effect.state>)
// CHECK-NEXT:     pdl.pattern : benefit(1) {
// CHECK-NEXT:       %i32_type = pdl.type : i32
// CHECK-NEXT:       %lhs = pdl.operand
// CHECK-NEXT:       %rhs = pdl.operand
// CHECK-NEXT:       %root = pdl.operation "arith.addi" (%lhs, %rhs : !pdl.value, !pdl.value) -> (%i32_type : !pdl.type)
// CHECK-NEXT:       pdl.rewrite %root {
// CHECK-NEXT:         %smt_i32_type = pdl.type : !smt.bv.bv<32>
// CHECK-NEXT:         %smt_bool_type = pdl.type : !smt.bool
...
// CHECK-NEXT:         %lhs_payload = pdl.result 0 of %lhs_get_payload_op
// CHECK-NEXT:         %rhs_payload = pdl.result 0 of %rhs_get_payload_op
// CHECK-NEXT:         %lhs_poison = pdl.result 0 of %lhs_get_poison_op
// CHECK-NEXT:         %rhs_poison = pdl.result 0 of %rhs_get_poison_op
// CHECK-NEXT:         %get_payload_op = pdl.operation "smt.bv.add" (%lhs_payload, %rhs_payload : !pdl.value, !pdl.value) -> (%smt_i32_type : !pdl.type)
// CHECK-NEXT:         %payload = pdl.result 0 of %get_payload_op
// CHECK-NEXT:         %get_poison_op = pdl.operation "smt.or" (%lhs_poison, %rhs_poison : !pdl.value, !pdl.value) -> (%smt_bool_type : !pdl.type)
// CHECK-NEXT:         %poison = pdl.result 0 of %get_poison_op
// CHECK-NEXT:         %smt_pair_type = pdl.type : !smt.utils.pair<!smt.bv.bv<32>, !smt.bool>
// CHECK-NEXT:         %smt_pair_op = pdl.operation "smt.utils.pair" (%payload, %poison : !pdl.value, !pdl.value) -> (%smt_pair_type : !pdl.type)
// CHECK-NEXT:         %smt_pair = pdl.result 0 of %smt_pair_op
// CHECK-NEXT:         pdl.replace %root with %smt_pair_op
// CHECK-NEXT:       }
// CHECK-NEXT:     }
// CHECK-NEXT:   }
