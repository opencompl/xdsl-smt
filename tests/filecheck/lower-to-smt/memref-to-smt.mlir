...
// CHECK-NEXT:      %9 = mem_effect.write %value, %3[%8] : !smt.utils.pair<!smt.bv.bv<8>, !smt.bool>
// CHECK-NEXT:      %10 = "smt.bv.constant"() {value = #smt.bv.bv_val<97: 64>} : () -> !smt.bv.bv<64>
// CHECK-NEXT:      %11 = mem_effect.offset_ptr %4[%10]
// CHECK-NEXT:      %12, %val = mem_effect.read %9[%11] : !smt.utils.pair<!smt.bv.bv<8>, !smt.bool>
// CHECK-NEXT:      "smt.return"(%val, %12) : (!smt.utils.pair<!smt.bv.bv<8>, !smt.bool>, !effect.state) -> ()
